...
def analyze(request):
    ...
    payload = {"aoi": aoi_geojson, "cloud_pct": 20, "days_back": 30}
    ...
    def worker():
        try:
            _write_status(run_dir, "running", "Generating demo outputs (offline)")
            bbox, hotspots = _demo_hotspots_from_aoi(aoi_geojson, n=6)
